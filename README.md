# Tim Huitt
Full Stack Engineer based in Broomfield, Colorado.

I build production systems end-to-end - from data architecture and backend APIs to frontend interfaces and cloud infrastructure. My background spans management, financial advisory, and data analytics, providing me with a unique perspective on what a business and its clients need from the products I deliver.

Most recently, I spent 18 months as the sole engineer on a HIPAA-compliant production platform, including dual portal architecture, 70+ table data model, Salesforce and QuickBooks migration, and full AWS infrastructure.
